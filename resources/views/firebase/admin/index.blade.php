...
@section('content')
    <style>
        ...
        body::after {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 30% 30%, rgba(255, 75, 75, 0.1), transparent),
            linear-gradient(to bottom right, rgba(255, 75, 75, 0.05), rgba(0, 0, 0, 0.9));
            z-index: -1;
        }
        ...
        .grid-lines::before {
            ...
            width: 100%;
            height: 100%;
            background-image: linear-gradient(to right, rgba(255, 75, 75, 0.05) 1px, transparent 1px),
            linear-gradient(to bottom, rgba(255, 75, 75, 0.05) 1px, transparent 1px);
    ...
    <div class="login-container">
        <div class="login-card animate-in">
            <div class="login-body">
                ...
                <!-- Login Form -->
                <form method="POST" action="{{ route('firebase.admin.loginadmin.submit') }}">
                    @csrf
