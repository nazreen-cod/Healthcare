...
@section('content')
    <style>
        ...
        /* Additional improved audit log styles */
        .audit-log-table {
            width: 100%;
        ...
        <div class="form-wrapper animate-in">
            ...
            <div class="cyber-card">
                <h3 class="cyber-card-header">
                    <i class="fas fa-user-md me-1"></i>Edit Doctor Info
                </h3>
                <div class="cyber-card-body">
                    <form method="POST" action="{{ route('firebase.admin.update_doctor', ['id' => $key]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="btn-container">
                            ...
                            <a href="{{ route('firebase.admin.show_doctor') }}" class="btn-cyber-secondary">
