...
@section('content')
    ...
    <div class="main-container">
        <div class="form-wrapper animate-in">
            <h1 class="page-header">Update Pharmacist</h1>

            <!-- Connection Error -->
            @if(isset($connectionError))
                <div class="network-error">
                    <i class="fas fa-wifi-slash network-error-icon"></i>
                    <div class="network-error-title">Connection Error</div>
                    <div class="network-error-message">
                        Unable to connect to Firebase. This could be due to network issues or server maintenance.
                        <br>Error: {{ $connectionError }}
                    </div>
            ...
            @else
                ...
                <div class="cyber-card">
                    <div class="cyber-card-header">
                        <div><i class="fas fa-prescription-bottle-alt me-1"></i>Edit Pharmacist Info</div>
                    </div>
                    <div class="cyber-card-body">
                        <form method="POST" action="{{ route('firebase.admin.update_pharmacist', ['id' => $key ?? '' ]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            @if(isset($editdata))
                                        ...
                                        <div class="form-row">
                                            <div class="form-col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="numberMMC" name="numberMMC" class="form-control" value="{{ $editdata['numberMMC'] ?? '' }}" maxlength="5" required>
                                            ...
                                            <div class="form-col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="numberAPC" name="numberAPC" class="form-control" value="{{ $editdata['numberAPC'] ?? '' }}" maxlength="5" required>
                                ...
                                <div class="btn-container">
                                    <button type="submit" class="btn-cyber-primary">
                                        <i class="fas fa-save me-1"></i>Update Pharmacist
                                    </button>
                            ...
                            @else
                                <div class="alert alert-danger">
                                    ...
                                    Unable to load pharmacist data. Please try again later.
                                </div>
                                <div class="btn-container">
                                    <a href="{{ route('firebase.admin.show_pharmacist') }}" class="btn-cyber-secondary" style="flex: 1;">
                ...
                <!-- Audit Log Section -->
                @if(isset($auditLogs) && count($auditLogs) > 0 && isset($editdata))
                    <div class="cyber-card">
                        <div class="cyber-card-header">
                            <div>
