...
@section('content')
    ...
    <div class="container">
        <h1 class="page-header animate-in">Nurse Management</h1>
        ...
        <div class="table-container animate-in" style="animation-delay: 0.1s;">
            ...
            <div class="cyber-card">
                <div class="cyber-card-header">
                    <span><i class="fas fa-user-nurse me-2"></i>Nurse List</span>
                    <a href="{{ route('firebase.admin.reg_nurse') }}" class="btn-cyber-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('firebase.admin.edit_nurse', ['id' => $key]) }}" class="btn-cyber-primary btn-cyber-edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('firebase.admin.delete_nurse', ['id' => $key]) }}" class="btn-cyber-primary btn-cyber-delete" onclick="return confirm('Are you sure you want to delete this nurse?')">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="empty-state">
                                    <i class="fas fa-user-nurse fa-3x mb-3 d-block mx-auto" style="opacity: 0.3;"></i>
